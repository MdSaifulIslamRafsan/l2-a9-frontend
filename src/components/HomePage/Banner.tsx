      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              <Link href="/auth/register">
                <Button
                  variant="outline"
                  className="border-primary text-primary dark:text-white hover:bg-green-50"
                >
                  Join Now
                </Button>
              </Link>
          ...
          <div className="flex justify-center lg:justify-end">
            ...
            <div className="absolute -top-6 -left-6 bg-primary rounded-lg p-4 shadow-lg">
              ...
              />
                ...
                <div className="absolute -bottom-6 -right-6 bg-primary rounded-lg p-4 shadow-lg">
                  <Star className="h-8 w-8 text-white" />
                </div>
